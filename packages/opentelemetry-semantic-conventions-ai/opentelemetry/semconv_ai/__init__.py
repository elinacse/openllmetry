...
class SpanAttributes:
    ...
    MCP_TOOL_STATUS = "mcp.tool.status"
    MCP_TOOL_ERROR_TYPE = "mcp.tool.error.type"
    MCP_TOOL_ERROR_MESSAGE = "mcp.tool.error.message"
    MCP_CLIENT_ID = "mcp.client.id"
    MCP_CLIENT_NAME = "mcp.client.name"
    MCP_TRANSPORT_MODE = "mcp.transport.mode"
    MCP_PROTOCOL_VERSION = "mcp.protocol.version"
    MCP_REQUEST_START_TIME = "mcp.request.start_time"
    MCP_REQUEST_END_TIME = "mcp.request.end_time"
    MCP_REQUEST_DURATION_MS = "mcp.request.duration_ms"
    MCP_TOOL_EXECUTION_DURATION_MS = "mcp.tool.execution.duration_ms"
    MCP_STREAM_DURATION_MS = "mcp.stream.duration_ms"
    MCP_REQUEST_SIZE_BYTES = "mcp.request.size_bytes"
    MCP_RESPONSE_SIZE_BYTES = "mcp.response.size_bytes"
    MCP_RESPONSE_CHUNK_COUNT = "mcp.response.chunk_count"
    MCP_TOOL_OUTPUT_SIZE_BYTES = "mcp.tool.output.size_bytes"
